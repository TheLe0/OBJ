...
public class Inicio extends GLJPanel implements GLEventListener {
	...
	// COLOQUE AQUI O NOME DO ARQUIVO OBK A SER LIDO DENTRO DA PASTA MODELS
	private Boolean loadModels(GL2 gl) {
		model = ModelLoaderOBJ.LoadModel("./models/parthenon.obj",gl);
		if (model == null) {
			return false;
		}
		return true;
	...
	public static void main(String[] args) {
		...
		window.getContentPane().add(new Inicio());
